...
tarball_name = "MasterBall.tar.gz"
...
for line in txtfile:
    ...
    os.system("echo Executable = runOneMain_Data.csh >> {0}".format(jdl_filename))
    ...
    os.system("echo Transfer_Input_Files = runOneMain_Data.csh, {0} >> {1}".format(tarball_name, jdl_filename))
    ...
    os.system("condor_submit {0}  -debugfile /tmp/3wolf3_Testing_{1}.log".format(jdl_filename,number))
