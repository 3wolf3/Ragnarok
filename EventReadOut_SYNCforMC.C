...
void EventReadOut_SYNCforMC(TString var_Sample = "",TString isMC = "", TString singleFile = ""){
...
//8888888888888888888888888888888888888888888888888888888888888888888888888888888888888888
	if(singleFile == ""){
		...
		isMC = "false";	
		singleFile = "yggdrasil_treeMaker_ttH_sync_June5_SYNCforData_MuonEG_PeriodB_FullLumi.root";//"ttH_SYNCforMC_June4_nTuple.root";
		
		//"root://cmseos.fnal.gov//store/mc/RunIIFall17MiniAODv2/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/PU2017_12Apr2018_new_pmx_94X_mc2017_realistic_v14-v1/60000/AC628CE7-0169-E811-9C5E-00010100096B.root"; 
		var_Sample = "MuonEG_PeriodB";//"ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8"; 
			//"MuonEG_PeriodB";
			//"DoubleMuon_PeriodB";
...
//        cout << outSingleFile << endl;
	...
	TString inputDLTriggerSF = "inputData/tth_dileptonic_2DscaleFactors_withSysts_2017BCDEF_01-17-19.root";
	//"inputData/tth_dileptonic_2DscaleFactors_withSysts_2017BCDEF_11-26-18.root";
...
//8888888888888888888888888888888888888888888888888888888888888888888888888888888888888888
  // *** 2. Set tree structure and variables to read
	...
	std::vector<double> GoodJetsDeepCSV_b_bb;
	...
	outputCSV = "syncExercise_"+output+"_EventReadOut_SYNCforMC_"+singleFile+".csv";
        fCSV.open(outputCSV);
...
*/	
	...
	//=============Applying the CSV correction factors=========================================================
			...
			if (applyIndCSVsf == 1){
				...
				GoodJetsDeepCSV_b_bb.push_back(JetCSV_b+JetCSV_bb);
...
*/
			...
			GoodJetsDeepCSV_b.push_back(eve->jet_DeepCSV_b_[0][JetNumber]);
                	...
                	GoodJetsDeepCSV_b_bb.push_back((eve->jet_DeepCSV_b_[0][JetNumber]) + (eve->jet_DeepCSV_bb_[0][JetNumber]));
			NumberOfGoodJets = NumberOfGoodJets + 1;
		}
		//NumberOfGoodJets = NumberOfGoodJets + 1;
                indexJets.clear();
...
*/
	...
	if(var_TrigSFxx != "noTrigSF"){
		...
		if(eve->evt_ == EventNumber || eve->evt_%7777719==0 || eve->evt_ == 571973928){	//%10==0){
			cout << endl;
			cout<<"====================================="<<endl;
...
//		if(DEBUG ==1)cout<<"Writing values to CSV file...."<<endl;
		...
		fCSV<< GoodJetsPT.at(indexJets[0]) << "," << GoodJetsEta.at(indexJets[0]) << "," << GoodJetsPhi.at(indexJets[0])<<","<<"jet1_jesSF"<<","<<"jet1_jesSF_up,"<<"jet1_jesSF_down,"<<"jet1_jesSF_PileUpDataMC_down,"<<"jet1_jesSF_RelativeFSR_up,"<<"jet1_jerSF_nominal,"<<GoodJetsDeepCSV_b_bb.at(indexJets[0])<<","<<"jet1_PUJetId,"<<"jet1_PUJetDiscriminant,";
		...
		fCSV<<GoodJetsPT.at(indexJets[1])<<","<<GoodJetsEta.at(indexJets[1])<<","<<GoodJetsPhi.at(indexJets[1])<<","<<"jet2_jesSF"<<","<<"jet2_jesSF_up,"<<"jet2_jesSF_down,"<<"jet2_jesSF_PileUpDataMC_down,"<<"jet2_jesSF_RelativeFSR_up,"<<"jet2_jerSF_nominal,"<<GoodJetsDeepCSV_b_bb.at(indexJets[1])<<","<<"jet2_PUJetId,"<<"jet2_PUJetDiscriminant,";
...
*/
	...
	TFile* fOut = new TFile("Output_Histograms_EventReadOut_SYNCforMC_CONDOR_" + outSingleFile, "RECREATE");
...
//      //      TString singleFile = argv[3];
	...
	EventReadOut_SYNCforMC(argv[1],argv[2],argv[3]);	
